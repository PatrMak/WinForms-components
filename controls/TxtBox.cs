...
namespace Controls
{
    ...
    public partial class TxtBox : UserControl
    {
        ...
        private Color borderFocusColor = Color.MediumBlue;
        private bool isFocused = false;
     //   private HorizontalAlignment textAligment = HorizontalAlignment.Left;
    ...
    //    private bool readOnly = false;
        ...
        private void SetTxtBoxRoundedRegion()
        {
            ...
            {
                pathTxt = GetFigurePath(textBox1.ClientRectangle, 2*borderSize);
                textBox1.Region = new Region(pathTxt);
            }
        }
        ...
        {
            if(string.IsNullOrWhiteSpace(textBox1.Text) && placeholderTxt !="")
            {
                isPlaceholder = true;
        ...
        {
            if (isPlaceholder && placeholderTxt != "")
            {
                isPlaceholder = false;
                textBox1.Text = "";
